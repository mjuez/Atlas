    ...
    getExtensionsFromPath(dir, callback) {
        ...
        addExtension(extension) {
            ...
            extension.on('deactivate', () => {
                this.sidebar.list.items[extension.constructor.name].element.classList.remove('active');
            });

            extension.on('activate', () => {
                this.sidebar.list.items[extension.constructor.name].element.classList.add('active');
            });
