...
class Input {
    constructor() {
        console.log("WARNING input is just a container of static methods, null returned");
        return null;
    }


    static chooseColor(event){
      
    }

    static colorInput(options){
