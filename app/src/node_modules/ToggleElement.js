...
class ToggleElement extends Evented {
    constructor(element) {
        super(element);
        this.id = element.id;
    }
    ...
    addToggleButton(options) {
        ...
        if (options.buttonsContainer) {
            ...
            this.on('show', (e) => {
                if (e.el.buttonsContainer.buttons[opt.id]) {
                    let cl = e.el.buttonsContainer.buttons[opt.id].className;
                    e.el.buttonsContainer.buttons[opt.id].className = cl + " active";
                }
            });
            ...
            this.on('hide', (e) => {
                if (e.el.buttonsContainer.buttons[opt.id]) {
                    let cl = e.el.buttonsContainer.buttons[opt.id].className;
                    e.el.buttonsContainer.buttons[opt.id].className = cl.replace('active', '');
                }
            });
        }
