        ...
        if (options.buttonsContainer) {
            ...
            this.on('show', (e) => {
                if (this.buttonsContainer.buttons[opt.id]) {
                    let cl = this.buttonsContainer.buttons[opt.id].className;
                    this.buttonsContainer.buttons[opt.id].className = cl + " active";
                }
            });
            ...
            this.on('hide', (e) => {
                if (this.buttonsContainer.buttons[opt.id]) {
                    let cl = this.buttonsContainer.buttons[opt.id].className;
                    this.buttonsContainer.buttons[opt.id].className = cl.replace('active', '');
                }
            });
        }
