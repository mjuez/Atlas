            ...
            switch (layerType) {
                case `points`:
                    jsonConfig = {
                        ...
                        tileSize: size[0],
                        size: size[1],
                        pointsUrlTemplate: `${destinationPath}${path.sep}points${path.sep}points_${filename.replace(/ /g,"_")}.csv`
                    }
                    break;
                ...
                case `pixels`:
                    jsonConfig = {
                        ...
                        tileSize: size[0],
                        size: size[1],
                        pixelsUrlTemplate: `${destinationPath}${path.sep}holes_pixels${path.sep}holes_${filename.replace(/ /g,"_")}.txt`
                    }
                    break;
            }
