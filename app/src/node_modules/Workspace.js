...
class Workspace extends GuiExtension {
    ...
    show() {
        Util.empty(this.pane.element, this.pane.element.firstChild);
        //  this.treeView.setObject(this.spaces);
        this.treeView = new TreeList(this.pane.element, this.spaces);
        super.show();
    }
        ...
        dialog.showSaveDialog({
            ...
            (fileName) => {
                ...
                if (fileName === undefined) {
                    console.log("You didn't save the workspace");
                    return;
                }
                ...
                fs.writeFile(fileName, content, (err) => {
                    ...
                    storage.set('workspace', this.spaces);
                    console.log(`The workspace has been succesfully saved`);
                    if (cl) {
                        cl();
                    }
                });
